...
<body>
	...
	<div id="workspace">
		...
		<ul id="opt-websheep" style=""> 
			<li data-action="addTool"> Adicionar uma ferramenta</li>
			<li data-action="addPlugin"> Adicionar plugin</li>
			<li data-action="addPaginate"> Adicionar uma paginação</li>
			<li data-action="addForm"> Adicionar um formulario/cadastro</li>
			<li data-action="addBootstrap"> Adicionar um template Bootstrap</li>
		</ul>
		<div id="editor-region">
			<div id="editor-top-bar">
				<div id="menu-websheep" style="">» Opções</div>
