(function(global, $){
    ...
    codiad.sidebars = {
        ...
        openLeftSidebar: function() {
            ...
            var _this = this;
            var timeout_r = $('#sb-left').data("timeout_r");
            if (timeout_r) {
                clearTimeout(timeout_r);
            }
            var sbarWidthL = $("#sb-left").width(),
                sbarWidthR = $("#sb-right").width();
            if (!codiad.sidebars.rightLock) {
                sbarWidthR = 10;
            }
            $('#editor-region').animate({
                'margin-left': sbarWidthL + 'px'
                    ...
                    $("#opt-websheep").css({top:30,left:$("#menu-websheep").offset().left+15});
                });
            $('#sb-left').animate({
                'left': '0px'
            }, 300, 'easeOutQuart',function(){});
        ...
        closeLeftSidebar: function() {
            ...
            $('#sb-left').data("timeout_r", setTimeout($.proxy(function() {
