    ...
    init: function (editor) {
        ...
        var defaultConfig = {
            ...
            charCountGreaterThanMaxLengthEvent: function (currentLength, maxLength) {
                TopAlert({
                    mensagem:"Ops este campo de texto permite apenas "+maxLength+" caracteres.",
                    clickclose:true,
                    height:20,
                    timer:3000,
                    type:1,
        ...
        if (config.showParagraphs) { defaultFormat += editor.lang.wordcount.Paragraphs + " %paragraphs%";}
