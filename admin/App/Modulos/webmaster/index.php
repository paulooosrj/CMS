		...
		$.getScript('/admin/App/Vendor/ace/src-min-noconflict/ext-language_tools.js', function() {
				...
				window.refreshClick = function() {
					...
					$('#novoArquivo').unbind('tap click').bind('tap click', function() {
						confirma({
							width: "auto",
							conteudo: "  Aguarde...<div class=\'preloaderupdate\' style=\'left: 50%;margin-left: -15px; position: absolute;width: 30px;height: 18px;top: 53px;background-image:url(\"./img/loader_thumb.gif\");background-repeat:no-repeat;background-position: top center;\'></div>",
							drag: false,
							bot1: 0,
							bot2: 0
						})
							...
							newFun: function() {
								functions({
									...
									beforeSend: function() {
										confirma({
											width: "auto",
											conteudo: "  Excluindo...<div class=\'preloaderupdate\' style=\'left: 50%;margin-left: -15px; position: absolute;width: 30px;height: 18px;top: 53px;background-image:url(\"./img/loader_thumb.gif\");background-repeat:no-repeat;background-position: top center;\'></div>",
											drag: false,
											bot1: 0,
											bot2: 0
										})
