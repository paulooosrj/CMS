<?php
	...
	############################################################################################################################################
		...
		@file_put_contents(ROOT_DOCUMENT 	.'/website/assets/upload-files/.htaccess', 'RewriteEngine Off');
		@file_put_contents(ROOT_DOCUMENT 	.'/website/assets/upload-files/thumbnail/.htaccess', 'RewriteEngine Off');
		@file_put_contents(ROOT_DOCUMENT 	.'/website/assets/libraries/.htaccess', 'RewriteEngine Off');
		@file_put_contents(ROOT_DOCUMENT 	.'/website/assets/css/.htaccess', 'RewriteEngine Off');
		@file_put_contents(ROOT_DOCUMENT 	.'/website/assets/js/.htaccess', 'RewriteEngine Off');
		@file_put_contents(ROOT_DOCUMENT 	.'/website/assets/img/.htaccess', 'RewriteEngine Off');
		@file_put_contents(ROOT_DOCUMENT 	.'/website/assets/template/.htaccess', 'RewriteEngine Off');
		@file_put_contents(ROOT_DOCUMENT 	.'/website/assets/fonts/.htaccess', 'RewriteEngine Off');
